...
**ID —** Merak (MerakNK / Kampung Merak) adalah aplikasi Flutter untuk mengelola peternakan burung merak secara menyeluruh: telemetri inkubator IoT real-time (suhu, kelembapan, kontrol lampu/rotasi/mist), manajemen silsilah indukan (F0/F1/F2), siklus telur & anakan, CCTV live, penjualan, dan keuangan khusus pemilik — semuanya terhubung ke backend FastAPI di `https://***REMOVED***`.
