class AppConfig {
  ...
  static const mqttUrl = String.fromEnvironment(
    'MQTT_URL',
    defaultValue: 'wss://***REMOVED***.s1.eu.hivemq.cloud:8884/mqtt',
  );
  ...
  // Samakan firmware ESP32 (esp32/incubator_controller.ino): ***REMOVED*** (q).
  static const mqttUsername = String.fromEnvironment('MQTT_USERNAME', defaultValue: '***REMOVED***');
  static const mqttPassword = String.fromEnvironment('MQTT_PASSWORD', defaultValue: '***REMOVED***');
